    <div style="text-align:center" id="menu row d-inline col-md-12">
        ...
        <input class="form-control" type=text name="searchString" placeholder="検索" style="margin-top:5px;width:145px;height:40px;"><button  style="margin-top:5px;width:90px;height:40px;" class="form-control" type=input>
